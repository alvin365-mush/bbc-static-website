...
function Hero({ data }) {
  return (
    <div className="relative mx-auto bg-[url('https://news.files.bbci.co.uk/vj/live/idt-images/image-slider-hello/SMOG_vdyw4.jpg')] bg-cover  z-10  h-[300px] sm:h-[400px] lg:h-[500px] xl:h-[600px] 2xl:h-[700px] bg-gradient-to-t from-black">
